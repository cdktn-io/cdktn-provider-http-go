...
func (d *jsiiProxy_DataHttpRetryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataHttpRetryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
